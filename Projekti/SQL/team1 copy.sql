...
-- DROP TABLES IF EXISTS (poistetaan vanhat taulut)
...
CREATE TABLE `opettajat` (
  `Tunnusnumero` int(11) NOT NULL AUTO_INCREMENT,
  `Etunimi` varchar(30) NOT NULL,
  `Sukunimi` varchar(30) NOT NULL,
  `Aine` varchar(30) NOT NULL,
  PRIMARY KEY (`Tunnusnumero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `opiskelijat` (
  `Opiskelijanumero` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `kurssit` (
  ...
  PRIMARY KEY (`Tunnus`),
  KEY `fk_opettaja` (`Opettaja`),
  KEY `fk_tila` (`Tila`),
  CONSTRAINT `fk_opettaja` FOREIGN KEY (`Opettaja`) REFERENCES `opettajat` (`Tunnusnumero`),
  CONSTRAINT `fk_tila` FOREIGN KEY (`Tila`) REFERENCES `tilat` (`Tunnus`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `kurssikirjautuminen` (
  ...
  PRIMARY KEY (`Tunnus`),
  KEY `fk_opiskelija` (`Opiskelija`),
  KEY `fk_kurssi` (`Kurssi`),
  CONSTRAINT `fk_opiskelija` FOREIGN KEY (`Opiskelija`) REFERENCES `opiskelijat` (`Opiskelijanumero`),
  CONSTRAINT `fk_kurssi` FOREIGN KEY (`Kurssi`) REFERENCES `kurssit` (`Tunnus`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
