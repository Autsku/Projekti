...
// Määritetään mikä taulu valitaan URL-parametrin perusteella
$table = $_GET['table'] ?? 'opiskelijat';
$success_message = '';
$error_message = '';

// Validoidaan taulun nimi turvallisuussyistä
...
// Haetaan opettajat ja kurssit dropdown-valikoita varten
$opettajat = [];
$kurssit = [];
$opiskelijat = [];
...
try {
    ...
    // Jatka normaalisti vaikka dropdown-datat ei saataisi
}

// Määritetään otsikko ja paluulinkki
$titles = [
        ...
        <form method="POST">
            <?php if ($table == 'opiskelijat'): ?>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text">Syötä vuosikurssi (1-5)</div>
                </div>
